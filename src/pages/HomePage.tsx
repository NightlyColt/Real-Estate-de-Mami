  ...
  return (
    <div className="overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/propiedades"
                className="bg-brand-accent text-brand-dark px-8 py-4 rounded-full font-bold text-lg flex items-center justify-center gap-2 hover:bg-brand-accent/90 transition-all shadow-xl shadow-brand-accent/20"
              >
                Ver Propiedades
                <ArrowRight size={20} />
              </Link>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-white/10">
              <div>
                ...
                <div className="text-xs uppercase tracking-widest text-gray-400">Años de Exp.</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-1">500+</div>
                <div className="text-xs uppercase tracking-widest text-gray-400">Propiedades</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white mb-1">98%</div>
                <div className="text-xs uppercase tracking-widest text-gray-400">Clientes Felices</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative z-10 rounded-2xl overflow-hidden border-8 border-white/10 shadow-2xl aspect-[4/5] max-w-md mx-auto">
              <img 
            ...
            <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-brand-ocean/20 rounded-full blur-3xl" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-brand-primary relative overflow-hidden">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div className="relative">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-8 rounded-2xl shadow-2xl border border-brand-secondary/20 max-w-[240px] text-center">
          ...
          <div className="space-y-10">
            ...
            <div className="grid gap-8">
              {[
                ...
                <div key={i} className="flex gap-6 group">
                  <div className="w-14 h-14 shrink-0 rounded-2xl bg-white flex items-center justify-center shadow-sm group-hover:bg-brand-accent group-hover:text-white transition-all">
                    <item.icon size={28} />
                  </div>
                  <div>
            ...
            <Link
              to="/sobre-yoselin"
              className="inline-flex items-center gap-2 bg-brand-dark text-white px-8 py-4 rounded-full font-bold hover:bg-brand-dark/90 transition-all"
            >
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div
              ...
              className="bg-brand-primary p-10 rounded-3xl relative"
            >
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto bg-brand-ocean rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl shadow-brand-ocean/30">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contacto"
                className="bg-white text-brand-ocean px-10 py-5 rounded-full font-bold text-lg hover:bg-brand-primary transition-all"
              >
                Contáctame Ahora
              </Link>
              <a
                href="https://wa.me/18090000000"
                className="bg-brand-accent text-brand-dark px-10 py-5 rounded-full font-bold text-lg hover:bg-brand-accent/90 transition-all"
              >
                WhatsApp Directo
              </a>
            </div>
